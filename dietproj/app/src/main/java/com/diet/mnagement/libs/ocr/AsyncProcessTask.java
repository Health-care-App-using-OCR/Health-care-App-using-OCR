...
import com.diet.mnagement.libs.ocrsdk.Client;
import com.diet.mnagement.libs.ocrsdk.ProcessingSettings;
import com.diet.mnagement.libs.ocrsdk.Task;
...
//			!!! Please provide application id and password and remove this line. !!!
            ...
            restClient.applicationId = "ReceiptManagement";
            // You should get e-mail from ABBYY Cloud OCR SDK service with the application password
            restClient.password = "JeASt8Y1eXe4P2AmR3IH8bPa";

            publishProgress("업로드 중 입니다...");

            String language = "Korean, English"; // Comma-separated list: Japanese,English or German,French,Spanish etc.
			...
			*/
            ...
            while (task.isTaskActive())
            {
                ...
                Thread.sleep(5000);
                publishProgress("잠시만 기다려주세요");
                task = restClient.getTaskStatus(task.Id);
            }

            if (task.Status == Task.TaskStatus.Completed)
            {
                publishProgress("결과를 가져오는 중");
